...
class FactorStore(Base):
    ...
    macro_bond_10y_yield = Column(DECIMAL(12, 6))
    macro_credit_spread = Column(DECIMAL(12, 6))
    macro_usdcny = Column(DECIMAL(12, 6))
    macro_market_sentiment = Column(DECIMAL(12, 6))
    macro_margin_trend = Column(DECIMAL(12, 6))
    macro_north_flow_5d = Column(DECIMAL(12, 6))
