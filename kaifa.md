...
| `/rankings` | TOP10排名页 | 完整排名表格，支持按行业/市值筛选 |
...
| J07 | `generate_ranking` | 17:30 | 每个交易日 | 生成TOP10排名快照 |
